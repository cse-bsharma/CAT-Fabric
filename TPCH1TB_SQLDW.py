...
FROM (
	SELECT C_CUSTKEY
		,COUNT(O_ORDERKEY)
	FROM TPCH1TB.CUSTOMER
	LEFT OUTER JOIN TPCH1TB.ORDERS ON C_CUSTKEY = O_CUSTKEY
...
WHERE S_SUPPKEY = L1.L_SUPPKEY
	...
	AND EXISTS (
		SELECT *
		FROM TPCH1TB.LINEITEM L2
		WHERE L2.L_ORDERKEY = L1.L_ORDERKEY
			AND L2.L_SUPPKEY <> L1.L_SUPPKEY
		)
	AND NOT EXISTS (
		SELECT *
		FROM TPCH1TB.LINEITEM L3
